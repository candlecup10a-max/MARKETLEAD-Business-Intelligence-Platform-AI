...
### 3.2 Demand Batching & Pagination Architecture
- **Batch Scalability**: The lead scraper engine processes up to **100 customer demands per batch** (`count: 100`), combining live Gemini 3.7 Flash generation with a procedural pool of international enterprise buyers across 249 countries.
- **Dynamic Pagination**: The dashboard provides a per-page selector (`6`, `12`, `25`, `50`, `100 (All)`) and windowed page navigation to allow rapid scanning and management across high-volume lead portfolios.
